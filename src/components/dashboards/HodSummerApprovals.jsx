  ...
  const fetchRequests = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Specifically filter for Summer Leave
        setRequests(allReqs.filter(r => r.leaveType === 'Summer Leave'));
      }
    } catch (err) {
  ...
  return (
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        <h1 style={styles.pageTitle}>Summer Leave Approvals</h1>
...
export default HodSummerApprovals;