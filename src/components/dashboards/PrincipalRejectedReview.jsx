...
import { Check, X, Search, FileText, AlertTriangle, Calendar } from 'lucide-react';
...
const PrincipalRejectedReview = () => {
  ...
  const fetchRejectedRequests = async () => {
    try {
      setLoading(true);
      const res = await apiFetch('http://localhost:5000/api/principal/hod-rejected');
      if (res.ok) {
    ...
    try {
      const res = await apiFetch('http://localhost:5000/api/leave/action', {
        ...
        body: JSON.stringify({ 
          ...
          action: 'Approved', 
          comment: comment || "Accepted/Overruled by Principal" 
        })
      });
      if (res.ok) {
    ...
    <div style={styles.container}>
      <header style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Review and overrule upcoming leaves rejected by HoDs.</p>
        </div>
      </header>
      ...
      <div style={styles.card}>
        ...
        {loading ? (
           ...
           <div style={{padding: '60px', textAlign: 'center', color: '#94a3b8'}}>
             ...
             <p style={{margin: 0, fontSize: '16px'}}>No future rejected leaves to review.</p>
           </div>
        ) : (
             ...
             <table style={styles.table}>
               <thead>
                 <tr style={styles.trHeading}>
                   ...
                   <th style={styles.th}>HoD Reason</th>
                   ...
                   <tr key={req._id} style={styles.tr}>
                     ...
                     <td style={styles.td}>
                        <div style={{color: '#dc2626', fontSize: '12px', fontStyle: 'italic'}}>
                          "{req.hodApproval?.comment || 'No reason provided'}"
                        </div>
                     </td>
                     <td style={styles.td}>
                       <button 
         ...
         <div style={styles.modalOverlay}>
           <div style={styles.modalContent}>
             ...
             <p style={{color: '#64748b', marginBottom: '8px'}}>
               ...
               This will reverse the HoD's rejection and re-deduct leave balance.
             </p>
